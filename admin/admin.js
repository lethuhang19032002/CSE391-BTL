...
var posts = [
  ...
  },
  {
    ...
    content:
      "Năm 2008, chiếc điện thoại Android đầu tiên được bán ra thị trường, đồng thời mở ra một kỷ nguyên hoàn toàn mới cho điện thoại thông minh ngày nay. Android có mã nguồn mở và Google phát hành mã nguồn theo Giấy phép Apache. Chính mã nguồn mở cùng với một giấy phép không có nhiều ràng buộc đã cho phép các nhà phát triển thiết bị, mạng di động và các lập trình viên nhiệt huyết được điều chỉnh và phân phối Android một cách tự do. Các nhà sản xuất điện thoại thông minh như Samsung, Xiaomi, OPPO,… đều có thể sản xuất các mẫu máy chạy Android mà không phải mất bất cứ chi phí bản quyền nào cho Google. Tuy không thu phí bản quyền của Android nhưng hằng năm, doanh thu của Google từ hệ điều hành vẫn lên đến hàng tỷ USD. Vậy tại sao họ lại có thể kiếm ra tiền từ một sản phẩm miễn phí?",
    image: "",
  },
];
//Display posts
